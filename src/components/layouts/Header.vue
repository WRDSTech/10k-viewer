                ...
                <div class="main-logo">
                    <div class="row">
                        <div class="col-sm-2 col-md-6">
                            <img src="/common/img/wrds_logo.98ee7f3b.svg" alt="Wharton wrds Logo" />
                        </div>
                    </div>
                </div>
                <div id="menu-icon">
...
.header-nav .main-panel {
    transition: max-height .2s ease-out;
    max-height: 42px;
    overflow: visible;
}

.header-nav .utility-wrap .redbar {
    background: #a90533;
    height: 15px;
    position: absolute;
    top: 0;
...
.header-nav .utility-wrap .utility-links {
    float: right;
}
...
.header-nav .utility-wrap .utility-link .btn-group-sm a {
    color: #FFFFFF;
    font-size: 11px;
    padding: 5px 10px;
